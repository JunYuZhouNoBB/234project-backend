...
WebUI.setText(findTestObject('case7_Page_ProjectBackend/input_username'), username)

WebUI.setText(findTestObject('case7_Page_ProjectBackend/input_password'), password)
